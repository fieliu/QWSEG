custom_imports = dict(imports=['mmseg.datasets.mfnet', 'mmseg.datasets.transforms.loading'])

_base_ = [
    '../_base_/models/upernet_mae_classbalance.py',
    '../_base_/datasets/mfnet_768x768.py',
...
model = dict(
    ...
    decode_head=dict(
        ...
        num_classes=9,
        channels=768),
    auxiliary_head=dict(in_channels=768 * 2, num_classes=9),
