"""
RGB-T语义分割 - V1 Baseline Full Init (FMB权重完全初始化) - FMB 480x480
...
- 数据集：FMB_ALL (15类)
- 输入尺寸：480x480
- 权重初始化：使用FMB_save_iter_224000.pth完全初始化backbone、neck、decode_head、auxiliary_head
- 推理：滑动窗口
"""
...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint='/home/lh/code/QWSEG/seg/mmsegmentation-main-rgbt/pretrain/FMB_save_iter_224000.pth',
        map_location='cpu',
        strict=False,
        prefix='',
        revision=None),
