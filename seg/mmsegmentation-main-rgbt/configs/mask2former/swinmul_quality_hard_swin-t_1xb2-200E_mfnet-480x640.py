...
custom_imports = dict(
    imports=['mmseg.models.segmentors.swin_quality_hard',
             'mmseg.engine',
...
custom_keys['final_conv'] = dict(lr_mult=1.0, decay_mult=1.0)
custom_keys['final_norm'] = dict(lr_mult=1.0, decay_mult=1.0)
...
custom_hooks = [dict(type='TrainVisHook', interval=5, num_samples=2, mask_threshold=0.5),
