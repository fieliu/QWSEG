...
custom_imports = dict(
    imports=['mmseg.models.segmentors.swinmul_v12_nodeg_quality_disentangle',
             'mmseg.engine',
...
model = dict(
    type='SwinMulV12QualityDisentangleNoDeg',
...
train_dataloader = dict(num_workers=2)
val_dataloader = dict(num_workers=2)
