...
custom_imports = dict(
    imports=['mmseg.models.segmentors.swinmul_v12_quality_disentangle',
             'mmseg.engine',
             'mmseg.datasets.fmb',
...
model = dict(
    type='SwinMulV12QualityDisentangle',
    ...
    common_decode_head=_mask2former_head,
    rgb_private_decode_head=_mask2former_head,
    t_private_decode_head=_mask2former_head,
    quality_threshold=0.3,
    loss_align_weight=0.5,
    aux_loss_weight=0.3,
    quality_pretrained='./pretrain/fmb_best_quality_pyramid_net.pth',
