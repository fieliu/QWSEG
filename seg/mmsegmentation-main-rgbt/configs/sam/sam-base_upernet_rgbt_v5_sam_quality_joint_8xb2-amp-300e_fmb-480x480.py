"""
RGB-T语义分割 - V5 SAM QualityJoint (SAM通用分支 + 解耦 + 退化增强 + 质量网络联合微调) - FMB 480x480

架构说明：
- 在V4 SAM基础上实现真正的质量网络联合微调
...
_base_ = [
    './sam-base_upernet_rgbt_v2_sam_disentangle_8xb2-amp-200e_fmb-480x480.py',
]
...
custom_imports = dict(
    imports=['mmseg.models.backbones.lightweight_mae_branch',
             ...
             'mmseg.models.segmentors.rgbt_v5_sam_quality_joint',
