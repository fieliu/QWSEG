...
custom_imports = dict(
    imports=['mmseg.models.segmentors.mitmul_ablation',
             'mmseg.models.utils.quality_aware_pyramid_net',
             'mmseg.engine',
...
model = dict(
    type='MiTMulABV3Replace',
    data_preprocessor=data_preprocessor,
    pretrained=None,
    backbone=mit_b2,
    private_branch_rgb=mit_b2,
    private_branch_t=mit_b2,
    quality_pyramid_net=quality_pyramid_net,
