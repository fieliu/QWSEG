...
for pred_name in ['predictors_common_rgb', 'predictors_common_t',
    ...
    predictor_keys[f'{pred_name}'] = dict(lr_mult=0.1, decay_mult=1.0)
    for stage_id in range(4):
        predictor_keys[f'{pred_name}.{stage_id}.shared'] = dict(lr_mult=0.1, decay_mult=1.0)
        predictor_keys[f'{pred_name}.{stage_id}.gate_head'] = dict(lr_mult=0.1, decay_mult=1.0)
        predictor_keys[f'{pred_name}.{stage_id}.weight_head'] = dict(lr_mult=0.1, decay_mult=1.0)
