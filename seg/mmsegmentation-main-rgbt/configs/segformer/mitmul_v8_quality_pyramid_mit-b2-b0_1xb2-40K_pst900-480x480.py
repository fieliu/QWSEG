_base_ = [
    '../_base_/datasets/pst900_480x640.py',
    '../_base_/default_runtime.py',
]

custom_imports = dict(
    imports=['mmseg.models.segmentors.mitmul_v8_quality_pyramid',
...
model = dict(
    ...
    loss_quality_rank_weight=0.5,
    loss_quality_consist_weight=0.3,
    loss_quality_contrast_weight=0.01,
