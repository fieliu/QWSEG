...
from .pst900 import PST900Dataset
from .semantic_rt import SemanticRTDataset
...
__all__ = [
    ...
    'NYUDataset', 'HSIDrive20Dataset', 'FMBDataset', 'MFNetDataset',
    'PST900Dataset', 'SemanticRTDataset'
]
