...
class LoadRGBTImageFromFile(BaseTransform):
    """Load RGB and Thermal images from separate files and concatenate them.
    ...
    Args:
        ...
        color_type (str): The flag argument for :func:`mmcv.imfrombytes`
            for the RGB image. Defaults to 'color'.
        ir_color_type (str): The flag argument for :func:`mmcv.imfrombytes`
            for the thermal/IR image. Use 'unchanged' for single-channel
            thermal images. Defaults to 'color'.
        ...
        ir_replace_src (str): The source string in img_path to be replaced
            to get the IR/thermal image path. Defaults to
            'ADEChallengeData2016'.
        ir_replace_dst (str): The destination string to replace with.
            Defaults to 'ADEChallengeData2016_T'.
    """

    def __init__(self,
                 to_float32: bool = False,
                 color_type: str = 'color',
                 ir_color_type: str = 'color',
                 imdecode_backend: str = 'cv2',
                 file_client_args: Optional[dict] = None,
                 ignore_empty: bool = False,
                 *,
                 backend_args: Optional[dict] = None,
                 ir_replace_src: str = 'ADEChallengeData2016',
                 ir_replace_dst: str = 'ADEChallengeData2016_T') -> None:
        self.ignore_empty = ignore_empty
        self.to_float32 = to_float32
        self.color_type = color_type
        self.ir_color_type = ir_color_type
        self.imdecode_backend = imdecode_backend
        self.ir_replace_src = ir_replace_src
        self.ir_replace_dst = ir_replace_dst
    ...
    def transform(self, results: dict) -> Optional[dict]:
        ...
        filename_ir = filename.replace(self.ir_replace_src,
                                       self.ir_replace_dst)
        try:
            ...
            img_ir = mmcv.imfrombytes(
                img_bytes_ir, flag=self.ir_color_type,
    ...
    def __repr__(self):
        repr_str = (f'{self.__class__.__name__}('
                    ...
                    f"ir_color_type='{self.ir_color_type}', "
                    f"imdecode_backend='{self.imdecode_backend}', "
                    f"ir_replace_src='{self.ir_replace_src}', "
                    f"ir_replace_dst='{self.ir_replace_dst}', ")
...
@TRANSFORMS.register_module()
class LoadRGBTImageFrom4Channel(BaseTransform):
