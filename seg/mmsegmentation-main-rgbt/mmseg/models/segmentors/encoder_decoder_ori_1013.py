...
class EncoderDecoder(BaseSegmentor):
    ...
    def encode_decode(self, inputs: Tensor,
        ...
        x_stage0 = x_rgbt[0][:B_size,:,:,:] + x_rgbt[0][B_size:,:,:,:]
        x_stage1 = x_rgbt[1][:B_size,:,:,:] + x_rgbt[1][B_size:,:,:,:]
        x_stage2 = x_rgbt[2][:B_size,:,:,:] + x_rgbt[2][B_size:,:,:,:]
        x_stage3 = x_rgbt[3][:B_size,:,:,:] + x_rgbt[3][B_size:,:,:,:]
