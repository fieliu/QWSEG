...
class MiTBaselineMamba(BaseSegmentor):
    ...
    def _train_with_degradation(self, rgb, ir):
        ...
        zc_r, zc_t, zp_r, zp_t, zf, re, te, ff = self._extract_feat_single(dr, di)
        return zc_r, zc_t, zp_r, zp_t, zf, re, te, ff, miss_rgb, miss_t
    ...
    def loss(self, inputs, data_samples):
        ...
        if self.training:
            dzcr, dzct, dzpr, dzpt, dzf, drl, dtl, df, miss_rgb, miss_t = self._train_with_degradation(rgb, ir)
