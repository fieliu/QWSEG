...
from ..utils.quality_network_v3 import (
    QualityNetworkV3, RankingMarginLoss, LevelConsistencyLoss,
    ImagePseudoLabelGenerator, ThermalPseudoLabelGenerator, IntraImageRankingLoss)
from ..utils.spatial_degradation_generator import SpatialDegradationGenerator


@MODELS.register_module()
class MiTMulV3Degradation(BaseSegmentor):
    ...
    def __init__(self,
        ...
        self.loss_intra_rank_weight = loss_intra_rank_weight
        ...
        self.intra_rank_fn = IntraImageRankingLoss(margin=0.0, top_k_ratio=0.3)
    ...
    def _compute_quality_training_losses(self, input_rgb, input_t):
        ...
        loss_intra_rgb = self.intra_rank_fn(all_rgb_q[0], rgb_pseudo)
        loss_intra_t = self.intra_rank_fn(all_t_q[0], t_pseudo)
        losses['loss_intra_rgb'] = loss_intra_rgb * self.loss_intra_rank_weight
        losses['loss_intra_t'] = loss_intra_t * self.loss_intra_rank_weight
