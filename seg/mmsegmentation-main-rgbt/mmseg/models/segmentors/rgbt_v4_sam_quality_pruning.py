...
class RGBTv4SAMQualityPruning(BaseSegmentor):
    ...
    def loss(self, inputs: torch.Tensor,
        ...
        (zc_rgb_list, zc_t_list, zp_rgb_list, zp_t_list,
         ...
         q_rgb, q_t) = self.extract_feat(inputs)
        ...
        if rgb_degraded_mask.any():
            loss_ceiling = self.high_deg_ceiling_fn(
                q_rgb[rgb_degraded_mask])
